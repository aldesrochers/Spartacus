...
int main(int argc, char** argv)
{
    ...
    TColStd_SequenceOfReal Strain, Temp, Time;
    ...
    Time.Append(0.);
    // 1
    Strain.Append(0.0005);
    Temp.Append(20.);
    Time.Append(0.);
    // 2
    Strain.Append(0.0010);
    Temp.Append(20.);
    Time.Append(0.);
    // 3
    Strain.Append(0.0015);
    Temp.Append(20.);
    Time.Append(0.);
    // 4
    Strain.Append(0.0020);
    Temp.Append(20.);
    Time.Append(0.);
    // 5
    Strain.Append(0.0025);
    Temp.Append(20.);
    Time.Append(0.);
    // 6
    Strain.Append(0.0030);
    Temp.Append(20.);
    Time.Append(0.);
    // 7
    Strain.Append(0.0030);
    ...
    Time.Append(1000.);
    // 10
    Strain.Append(0.0040);
    Temp.Append(30.);
    Time.Append(1000.);


    for(int i=1; i<=11; i++) {
        aModel->SetTrialStrain(Strain.Value(i));
        aModel->SetTrialTemperature(Temp.Value(i));
        aModel->SetTrialTime(Time.Value(i));
