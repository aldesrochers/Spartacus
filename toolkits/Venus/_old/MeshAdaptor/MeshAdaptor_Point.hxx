...
#ifndef __MeshAdaptor_Point_hxx__
#define __MeshAdaptor_Point_hxx__
...
class MeshAdaptor_Point;


// ============================================================================
/*!
 *  \brief MeshAdaptor_Point
*/
// ============================================================================
class MeshAdaptor_Point
{
...
public:
    // constructors
    Standard_EXPORT MeshAdaptor_Point();
    Standard_EXPORT MeshAdaptor_Point(const MeshDS_Vertex& theVertex);
    // destructors
    Standard_EXPORT ~MeshAdaptor_Point();
...
#endif // __MeshAdaptor_Point_hxx__
