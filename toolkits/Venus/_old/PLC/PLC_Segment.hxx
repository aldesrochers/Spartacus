...
#ifndef __PLC_Segment_hxx__
#define __PLC_Segment_hxx__
...
// Handles
DEFINE_STANDARD_HANDLE(PLC_Segment, Standard_Transient)
...
*/
// ============================================================================
class PLC_Segment : public Standard_Transient
{
    
public:
    // constructors
    Standard_EXPORT PLC_Segment();
    Standard_EXPORT PLC_Segment(const Standard_Integer theNode1,
...
public:
    ...
    DEFINE_STANDARD_RTTIEXT(PLC_Segment, Standard_Transient)

};

#endif // __PLC_Segment_hxx__
