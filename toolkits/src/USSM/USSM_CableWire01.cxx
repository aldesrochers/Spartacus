...
*/
// ============================================================================
Standard_Real USSM_CableWire01::MenegottoStiffness(const Standard_Real Eps,
...
*/
// ============================================================================
Standard_Real USSM_CableWire01::MenegottoStress(const Standard_Real Eps,
                                                const Standard_Real B)
{
...
*/
// ============================================================================
Standard_Real USSM_CableWire01::MonotonicStiffness(const Standard_Real Eps)
{
...
*/
// ============================================================================
Standard_Real USSM_CableWire01::MonotonicStress(const Standard_Real Eps)
{
    if(Eps > myParameters.EpsL()) {
...
*/
// ============================================================================
Standard_Real USSM_CableWire01::PolynomialStiffness(const Standard_Real Eps)
{
...
*/
// ============================================================================
Standard_Real USSM_CableWire01::PolynomialStress(const Standard_Real Eps)
{
    ...
    if(myTrialStrain >= myCommitStrain) {
        if(myTrialStrain >= myCurrentMaxStrain && myIsInitialLoading == Standard_True) {
            ...
            myTrialStress = F * (Sig0 - myCurrentMinStress)
                    + myCurrentMinStress;
            myTrialStiffness = MenegottoStiffness(Eps, B)
